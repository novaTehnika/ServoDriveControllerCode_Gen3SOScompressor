...
**Phase 4 (Homing)**:
- [ ] Encoder validity check at startup
- [ ] Mode 110: Approach, detect, backoff, setref sequence
- [ ] Mode 110: flagAbsHomeRequired cleared
- [ ] Mode 111: Fast approach, slow approach, stall detect, setref
- [ ] Mode 111: flagEOTHomeRequired cleared
- [ ] Mode 101: Redirect to 110 when AbsHomeRequired
- [ ] Mode 101: Direct move when requirements met
- [ ] Homing abort on motion enable drop

**Phase 5 (Safety)**:
- [ ] Drive fault detection
- [ ] Encoder fault detection
- [ ] Unexpected limit switch fault
- [ ] Position limit exceeded fault
- [ ] Piston exit guard - position mode clamping
- [ ] Piston exit guard - velocity mode halt
- [ ] Piston exit guard - torque mode anomaly detection
- [ ] Fault reset handshake with code mirroring
